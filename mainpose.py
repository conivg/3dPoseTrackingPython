...
class Classificator:
    ...
    def jointsAppending(self, lmlist,lmlistReal):
        ...
        if(count == 1):
            ...
            self.shoulder_left.append(lmlist[11][1:].extend(lmlistReal[11][1:]))
...
def main():
    ...
    while True:
        ...
        if lmList:
            ...
            #     print(classificator.hip_right[-1][3])
            ...
            #                    classificator.listPosXLower.append(item[3])
            #                    classificator.listPosYLower.append(item[4])
            #                    classificator.listPosZLower.append(item[5])
            #                 xP, yP, zP, = classificator.knee_right[-1][3:]
            ...
            #             classificator.listPosYLower.append(item[4])
            #             classificator.listPosZLower.append(item[5])
            #         xP, yP, zP = classificator.ankle_right[-1][3:]
            ...
            #             classificator.listPosYLower.append(item[4])
            #             classificator.listPosZLower.append(item[5])
            #         xP, yP, zP = classificator.ankle_left[-1][3:]
            ...
            #    cvzone.putTextRect(img, "Descending arms", (width + 150, height - 150))  # 100,400
                if (classificator.listPosXLower.__len__() > 2):
                    ...
                    difY = (classificator.listPosYLower[-1] - classificator.listPosYLower[-2])
                    ...
                    classificator.listDespCM.append(dif)
                    ...
                    cvzone.putTextRect(img, "speed:" f'{round(velprint,3)} cm/s', (800, 350))  # 100,400
